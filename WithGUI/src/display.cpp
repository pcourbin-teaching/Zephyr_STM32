...
void Display::task_handler()
{
    lv_task_handler();
}

void Display::lv_create_logo()
{
    /*Image From variable*/
...
void Display::init(bool with_chart)
{
...
void Display::chart_add_temperature(long value)
{
    lv_chart_set_next(chart, serie_temperature, value);
}

void Display::chart_add_humidity(long value)
{
    lv_chart_set_next(chart, serie_humidity, value);
}

void Display::text_add(char *text_to_add)
{
